...
addArrayProblems()
{
    ...
    dsProblemDB.add_dsProblem(DSTYPE_ARRAY, "Maximum_Area_Of_A_Piece_Of_Cake_After_Horizontal_And_Vertical_Cuts");
    dsProblemDB.add_dsProblem(DSTYPE_ARRAY, "Product_Array_Puzzle");
